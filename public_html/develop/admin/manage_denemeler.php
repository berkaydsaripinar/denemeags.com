                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="btn-group">
                                        ...
                                        <!-- Cevap Anahtarı Butonu -->
                                        <a href="manage_cevaplar.php?deneme_id=<?= $d['id'] ?>" class="btn btn-sm btn-warning" title="Cevap Anahtarı">
                                            <i class="fas fa-key"></i> Cevaplar
                                        </a>
                                        ...
                                        <?php $questionPreviewUrl = get_document_preview_url($d['soru_kitapcik_dosyasi'] ?? '', 'question'); ?>
                                        <?php if ($questionPreviewUrl): ?>
                                            <a href="<?= escape_html($questionPreviewUrl) ?>" target="_blank" class="btn btn-sm btn-outline-secondary" title="PDF Görüntüle">
