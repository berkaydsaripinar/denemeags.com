            ...
            <div class="card shadow-lg border-0 card-theme">
                <div class="card-body p-5">
                    ...
                    <div class="agreement-content text-dark">
                        ...
                        <p><strong>6.1.</strong> Platform üzerindeki ücretli içeriklerin satışı, güvenli ödeme altyapısı sağlayan <strong>PAYTR</strong> veya benzeri yetkili aracı kuruluşlar üzerinden gerçekleştirilir. Ödeme güvenliği, ilgili aracı kuruluşun sorumluluğundadır.</p>
