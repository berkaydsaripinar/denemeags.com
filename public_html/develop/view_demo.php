...
try {
    ...
    $file_path = resolve_document_file_path($target_file, 'demo');

    if (empty($target_file) || !$file_path || !file_exists($file_path)) {
    ...
    for ($i = 1; $i <= $maxPages; $i++) {
        ...
        $mpdf->Cell(0, 10, "Bu bir tanitim dokumanidir. Tamami icin " . parse_url(get_base_url(), PHP_URL_HOST) . " uzerinden satin aliniz.", 0, 0, 'C');
    }
